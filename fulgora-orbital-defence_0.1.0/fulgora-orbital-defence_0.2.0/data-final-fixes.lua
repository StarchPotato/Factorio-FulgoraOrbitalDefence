...
data:extend({
  {
    type = "recipe",
    name = "fulgoran-spaceship-corpse-chunk2-recycling",
    category = "recycling",
	auto_recycle = false,
	enabled = false,
	subgroup = "space-crushing",
	order = "c-a-d",
    energy_required = 5,
	icon = "__fulgora-orbital-defence__/graphics/icons/fulgoran-spaceship-corpse-chunk2-recycling.png",
    icon_size = 64,
    ingredients = {
      { type = "item", name = "fulgoran-spaceship-corpse-chunk2", amount = 1 }
    },
...
if space_platform_tech then
  table.insert(space_platform_tech.effects, {
    type = "unlock-recipe",
    recipe = "fulgoran-spaceship-corpse-chunk2-recycling"
  })
end